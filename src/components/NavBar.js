...
export default function NavBar() {
    ...
    const activeNav = (path) => router.pathname == path ? "activeNav" : '';
        ...
        <nav className="navbar">
            <div className="navContent">
                ...
                <ul className="items">
                    ...
                    <li className={"item"+ ' ' + (activeNav('/about'))}>
                    ...
                    <li className={"item"+ ' ' + (activeNav('/projects'))}>
                    ...
                    <li className={"item"+ ' ' + (activeNav('/contact'))}>
